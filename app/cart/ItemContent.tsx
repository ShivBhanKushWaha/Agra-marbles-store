...
const ItemContent: React.FC<ItemContentProps> = ({item}) => {
  ...
  return (
    <div className="grid grid-cols-5 text-sm md:text-sm gap-4 border-t-[1.5px]
    border-slate-200 py-4 items-center">
        <div className="col-span-2 justify-self-start flex gap-2 md:gap-4">
            <Link href={`/product/${item.id}`}>
                <div className="relative w-[70px] cursor-pointer aspect-square">
        ...
        <div className="justify-self-center">
            ...
            handleQtyDecrease={() => {handleCartQtyDecrease(item)}} handleQtyIncrease={() => {handleCartQtyIncrease(item)}}/>
        </div>
